...
DocMeta.setdocmeta!(LinOps, :DocTestSetup, :(using LinOps); recursive = true)
...
makedocs(;
    modules = [LinOps],
    authors = "Ferreol Soulez <ferreol.soulez@univ-lyon1.fr>",
    repo = "https://github.com/ferreolS/LinOps.jl/blob/{commit}{path}#{line}",
    sitename = "LinOps.jl",
    format = Documenter.HTML(; canonical = "https://ferreolS.github.io/LinOps.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/ferreolS/LinOps.jl")

...
struct LinOpNFFT{
    ...
    size::S
    points::P
    LinOpNFFT(inputspace::I, outputspace::O, plan::F, dims::D, size::S, points::P) where {I <: AbstractDomain, O <: AbstractDomain, F, D, S <: NTuple, P} = new{I, O, F, D, S, P}(inputspace, outputspace, plan, dims, size, points)
end
